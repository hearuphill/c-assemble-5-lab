...
000011ad <main>:
    ...
    11b7:	e8 46 00 00 00       	call   1202 <__x86.get_pc_thunk.ax>
    11bc:	05 20 2e 00 00       	add    $0x2e20,%eax
    11c1:	c7 45 f8 00 00 00 80 	movl   $0x80000000,-0x8(%ebp)
    11c8:	c7 45 fc 00 00 00 80 	movl   $0x80000000,-0x4(%ebp)
    11cf:	66 c7 45 f4 00 80    	movw   $0x8000,-0xc(%ebp)
    11d5:	66 c7 45 f6 00 80    	movw   $0x8000,-0xa(%ebp)
    11db:	c1 7d f8 04          	sarl   $0x4,-0x8(%ebp)
    11df:	c1 6d fc 04          	shrl   $0x4,-0x4(%ebp)
    11e3:	0f bf 45 f4          	movswl -0xc(%ebp),%eax
    11e7:	89 45 f8             	mov    %eax,-0x8(%ebp)
    11ea:	0f b7 45 f6          	movzwl -0xa(%ebp),%eax
    11ee:	89 45 f8             	mov    %eax,-0x8(%ebp)
    11f1:	0f bf 45 f4          	movswl -0xc(%ebp),%eax
    11f5:	89 45 fc             	mov    %eax,-0x4(%ebp)
    11f8:	0f b7 45 f6          	movzwl -0xa(%ebp),%eax
